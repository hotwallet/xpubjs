 ...
 */
   ...
   * @function
   */
  SHA256.prototype.reset       = hash._reset;
  /**
   * @see JSUCrypt.hash#update
   * @function
   */
  SHA256.prototype.update      = hash._update;
  /**
   * @see JSUCrypt.hash#finalize
   * @function
   */
  SHA256.prototype.finalize    = hash._finalize;
   ...
   * @function
   */
  SHA224.prototype.reset        = hash._reset;
  /**
   * @see JSUCrypt.hash#update
   * @function
   */
  SHA224.prototype.update       = hash._update;
  /**
   * @see JSUCrypt.hash#finalize
   * @function
   */
  ...
  SHA224.prototype._finalize256 = hash._finalize;
