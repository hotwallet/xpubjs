...
function anyToByteArray(any) {
  if (any == undefined) {
    return [];
  }
  if (typeof any =="string") {
    return hexStrToByteArray(any);
  }
  ...
  throw new Error("Invalid paramerter type:"+any);
}
  ...
  // --- shortcuts ---
  var UINT64  = function (h,l) {
    if (h == undefined) h = 0;
    if (l == undefined) l = 0;
    return {h:h, l:l};
  };

  var CLONE64  = function (x) {
    return {h:x.h, l:x.l};
  };
